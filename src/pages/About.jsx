import { Users, Shield, Settings, Globe, Server, Award, Clock } from 'lucide-react'
  ...
  <div className="border-b border-slate-800">
    <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <div>
          <span className="text-yellow-400 text-sm font-medium mb-2 block">About Us</span>
          ...
          <p className="text-gray-400 text-base sm:text-lg mb-6 sm:mb-8">
            We're dedicated to providing enterprise-grade hosting solutions with unmatched performance and reliability. Our mission is to empower businesses and individuals with
            cutting-edge server infrastructure.
          </p>
        </div>
        <div className="relative h-[250px] sm:h-[300px] lg:h-[400px] rounded-lg overflow-hidden">
          <img src="https://placehold.co/600x400" alt="Data Center" className="w-full h-full object-cover rounded-lg" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-16">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
        <div className="text-center">
          ...
          <div className="text-gray-400 text-sm sm:text-base">Active Servers</div>
        </div>
        <div className="text-center">
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-yellow-400 mb-2">40+</div>
          <div className="text-gray-400 text-sm sm:text-base">Data Centers</div>
        </div>
        <div className="text-center">
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-yellow-400 mb-2">100K+</div>
          <div className="text-gray-400 text-sm sm:text-base">Customers</div>
        </div>
        <div className="text-center">
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-yellow-400 mb-2">8</div>
          <div className="text-gray-400 text-sm sm:text-base">Years of Service</div>
        </div>
      </div>
    </div>
  </div>
  ...
  const values = [
    {
      ...
      description: 'We prioritize uptime and performance above all else, ensuring your services stay online.',
    },
    {
      icon: Users,
      title: 'Customer Focus',
      description: 'Our support team is available 24/7 to help you succeed with your hosting needs.',
    },
    {
      icon: Settings,
      title: 'Innovation',
      description: 'Constantly improving our infrastructure with the latest technology and security measures.',
    },
    {
      icon: Globe,
      title: 'Global Reach',
      description: 'Strategic data center locations worldwide for optimal performance everywhere.',
    },
  ]
  ...
  const timeline = [
    {
      ...
      description: 'Started with a vision to provide enterprise-grade hosting solutions.',
    },
    {
      year: '2017',
    ...
    },
    {
      ...
      description: 'Upgraded to latest generation hardware across all locations.',
    },
  ]
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="border-t border-slate-800 bg-slate-900/50">
        <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="relative h-[250px] sm:h-[300px] lg:h-[400px] rounded-lg overflow-hidden">
              <img src="https://placehold.co/600x400" alt="Server Infrastructure" className="w-full h-full object-cover rounded-lg" />
            </div>
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">State-of-the-Art Infrastructure</h2>
              <p className="text-gray-400 text-base sm:text-lg mb-6 sm:mb-8">
                Our data centers are equipped with the latest hardware and security measures to ensure optimal performance and protection for your applications.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-sm">Latest gen processors</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
