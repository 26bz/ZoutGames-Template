...
import { Coffee, Gem, Globe, GraduationCap, HeartPulse, MapPin, Monitor, Clock, ChevronDown, ChevronUp, Briefcase, Mail, Building, Calendar } from 'lucide-react'
  ...
  <div className="border-b border-slate-800">
    <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <div>
          <span className="text-yellow-400 text-sm font-medium mb-2 block">Careers</span>
          ...
          <p className="text-gray-400 text-base sm:text-lg mb-6 sm:mb-8">
            Build the future of cloud infrastructure with us. We're looking for passionate individuals who want to make an impact in the hosting industry.
          </p>
        </div>
        <div className="relative h-[250px] sm:h-[300px] lg:h-[400px] rounded-lg overflow-hidden">
          <img src="https://placehold.co/600x400" alt="Team at work" className="w-full h-full object-cover rounded-lg" />
        </div>
      </div>
    </div>
  </div>
...
const JobCard = ({ title, department, location, type, description, requirements, responsibilities, salary, experience, postedDate }) => {
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between items-start">
          <div className="flex-1">
            ...
            <div className="text-base sm:text-lg font-semibold text-yellow-400 mb-3 sm:mb-4">{salary}</div>
          </div>
          <button
        ...
        <div className={`space-y-4 transition-all duration-300 text-sm sm:text-base ${isExpanded ? 'block' : 'hidden'}`}>
          <div>
          ...
          <div className="flex gap-4 pt-4">
            <a href={`mailto:careers@zoutgames.com?subject=Application for ${encodeURIComponent(title)}`} onClick={e => e.stopPropagation()}>
...
const CareersPage = () => {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Flexible hours and generous PTO policy to maintain a healthy balance.',
    },
    {
      icon: GraduationCap,
  ...
  const jobs = [
    {
      ...
      description: "We're looking for an experienced DevOps engineer to help scale our cloud infrastructure and implement best practices for our growing platform.",
      responsibilities: [
    ...
    },
    {
      ...
      description: 'Join our support team to help customers succeed with our hosting solutions while providing exceptional technical assistance.',
      responsibilities: [
    ...
    },
    {
      ...
      description: 'Drive product marketing strategy and execution for our hosting products while working closely with product and sales teams.',
      responsibilities: [
    ...
    },
    {
      ...
      description: 'Build and maintain our customer-facing applications and internal tools using modern web technologies.',
      responsibilities: [
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24 border-b border-slate-800">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Why Work With Us</h2>
      ...
      <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">Open Positions</h2>
          ...
          {departments.map(dept => (
            <button
              ...
              className={`px-3 sm:px-4 py-2 rounded text-sm font-medium transition-colors
                ${selectedDepartment === dept ? 'bg-yellow-400 text-black' : 'bg-slate-950 text-gray-400 hover:bg-slate-800'}`}
            >
              {dept}
            </button>
          ))}
