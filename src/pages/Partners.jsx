import { Shield, Users, CheckCircle2, Store, BadgeCheck, Building2 } from 'lucide-react'
  ...
  <div className="border-b border-slate-800">
    <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
      <div className="max-w-3xl">
        <span className="text-yellow-400 text-sm font-medium mb-2 block">Partner Program</span>
        ...
        <p className="text-gray-400 text-base sm:text-lg mb-6 sm:mb-8">
          Partner with us to grow your business and provide your customers with enterprise-grade hosting solutions. Benefit from competitive commissions and dedicated support.
        </p>
      </div>
    </div>
  </div>
  ...
  const requirements = [
    {
      ...
      description: 'Must have a registered business entity and valid tax documentation.',
    },
    {
      icon: Users,
      title: 'Customer Base',
      description: 'Minimum of 10 active business customers or 1000+ monthly website visitors.',
    },
    {
      icon: Store,
      title: 'Marketing Presence',
      description: 'Established online presence with professional website and marketing materials.',
    },
    {
      icon: Shield,
      title: 'Technical Knowledge',
      description: 'Basic understanding of hosting services and technical support capabilities.',
    },
  ]
  ...
  const benefits = [
    {
      ...
      description: 'Earn up to 20% recurring commission on all referred customers.',
    },
    {
      title: 'Priority Support',
      description: 'Dedicated partner support team and priority ticket handling.',
    },
    {
      title: 'Marketing Resources',
      description: 'Access to marketing materials, training, and co-marketing opportunities.',
    },
    {
      title: 'Partner Portal',
      description: 'Exclusive access to our partner portal with real-time reporting.',
    },
  ]
  ...
  const partners = [
    {
      ...
      description: 'Leading provider of enterprise IT solutions and managed services.',
    },
    {
      name: 'WebPro Agency',
      type: 'Silver Partner',
      logo: 'https://placehold.co/100x100',
      description: 'Digital agency specializing in web development and hosting solutions.',
    },
    {
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24 border-b border-slate-800">
        <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Partnership Requirements</h2>
      ...
      <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24 border-b border-slate-800">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative h-[250px] sm:h-[300px] lg:h-[400px] rounded-lg overflow-hidden">
            <img src="https://placehold.co/600x400" alt="Partner Benefits" className="w-full h-full object-cover rounded-lg" />
          </div>
        </div>
      </div>
