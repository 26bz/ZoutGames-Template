        ...
        <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-400 text-base sm:text-lg">
              Review our terms of service, privacy policy, and acceptable use policy to understand your rights and responsibilities.
            </p>
          </div>
        </div>
      </div>
              ...
              return (
                <button
                  ...
                  className={`flex items-center px-4 sm:px-6 py-3 sm:py-4 border-b-2 transition-colors whitespace-nowrap text-sm sm:text-base
                    ${activeTab === tab.id ? 'border-yellow-400 text-yellow-400' : 'border-transparent text-gray-400 hover:text-gray-300'}`}
                >
      ...
      <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-8 sm:py-12 mb-16 sm:mb-32">
        <div className="mx-auto">
          ...
          <div className="mt-12 sm:mt-16 p-4 sm:p-6 bg-slate-900 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-400 mb-4 text-sm sm:text-base">If you have any questions about these policies, please contact our legal team.</p>
            <a href="mailto:legal@zoutgames.com" className="inline-flex items-center text-yellow-400 hover:text-yellow-600 transition-colors text-sm sm:text-base">
              Contact Legal Team
