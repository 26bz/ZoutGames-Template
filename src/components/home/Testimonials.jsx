...
const ReviewCard = ({ name, role, image, rating, content }) => (
  <div className="bg-slate-900 rounded-xl p-4 sm:p-6 border border-gray-800 h-full flex flex-col">
    <div className="flex justify-between items-start mb-4">
      <div className="flex items-center space-x-4">
        <div className="relative flex-shrink-0">
          <img src={image} alt={name} width={48} height={48} loading="lazy" className="w-12 h-12 rounded-full object-cover bg-slate-800" />
        </div>
        <div>
    ...
    <p className="text-gray-300 leading-relaxed text-sm sm:text-base line-clamp-6">{content}</p>
  </div>
)
  ...
  return (
    <section className="py-16 sm:py-32 bg-slate-950 border-t border-gray-800">
      <div className="container max-w-screen-xl mx-auto px-4 sm:px-6">
        <motion.div {...fadeInUp} viewport={{ once: true, margin: '-50px' }} className="text-center mb-8 sm:mb-12">
