  ...
  'Game Servers': [
    {
      ...
      answer: 'Yes, you can easily switch between different games through our control panel. Your server settings and data will be safely stored if you decide to switch back.',
    },
    {
      question: 'How many player slots do you offer?',
      answer: 'Our player slots vary by game and plan. We offer flexible scaling from 10 to 500+ slots depending on your needs and the game type.',
    },
    {
      question: 'Do you offer mod support?',
      answer: 'Yes, we fully support mods for all compatible games. Our control panel includes easy mod installation and management features.',
    },
  ],
  Billing: [
    {
      question: 'What payment methods do you accept?',
      answer: 'We accept major credit cards, PayPal, and various cryptocurrencies. All payments are processed securely through encrypted channels.',
    },
    {
      question: 'Can I upgrade my plan anytime?',
      answer: 'Yes, you can upgrade your plan at any time. The price difference will be prorated for your current billing cycle.',
    },
    {
      question: 'Do you offer refunds?',
      answer: "We offer a 24-hour money-back guarantee for all new servers. If you're not satisfied, simply contact our support team within this period.",
    },
  ],
}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {faqData[activeTab].map((item, index) => (
                ...
                >
                  <button onClick={() => handleQuestionClick(index)} className="w-full flex items-center justify-between p-4 text-left">
                  ...
                  <AnimatePresence>
                    {openQuestion === index && (
                      <motion.div initial={{ height: 0 }} animate={{ height: 'auto' }} exit={{ height: 0 }} transition={{ duration: 0.2 }} className="overflow-hidden">
                        <div className="p-4 pt-5 text-gray-400 border-t border-gray-700">{item.answer}</div>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </motion.div>
