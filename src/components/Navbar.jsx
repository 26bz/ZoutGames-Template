        ...
        <div className="flex items-center justify-between">
          <a href="/">
            <div className="flex items-center space-x-2">
              <div className="relative">
                <img src="https://placehold.co/50" alt="Logo" className="h-8 w-8" />
              </div>
          ...
          <div className="flex items-center space-x-4">
            <Link to="https://example.com/">
              <GlowingButton className="hidden md:block">Client Area</GlowingButton>
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pt-4 pb-3">
            <div className="flex flex-col space-y-4">
              {navLinks.map(link => (
                <Link key={link.name} to={link.href} className="text-gray-300 hover:text-yellow-400 transition-colors" onClick={() => setMobileMenuOpen(false)}>
                  {link.name}
                </Link>
              ))}
              <Link to="https://example.com/">
